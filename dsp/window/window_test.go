...
var windowTests = []struct {
	...
	{
		name: "Gaussian_0.3", fn: Gaussian{0.3}.Transform, fnCmplx: Gaussian{0.3}.TransformComplex,
		want: []float64{
	...
	{
		name: "Gaussian_0.5", fn: Gaussian{0.5}.Transform, fnCmplx: Gaussian{0.5}.TransformComplex,
		want: []float64{
	...
	{
		name: "Gaussian_1.2", fn: Gaussian{1.2}.Transform, fnCmplx: Gaussian{1.2}.TransformComplex,
		want: []float64{
	...
	{
		name: "Tukey_1", fn: Tukey{1}.Transform, fnCmplx: Tukey{1}.TransformComplex,
	...
	{
		name: "Tukey_0", fn: Tukey{0}.Transform, fnCmplx: Tukey{0}.TransformComplex,
	...
	{
		name: "Tukey_0.5", fn: Tukey{0.5}.Transform, fnCmplx: Tukey{0.5}.TransformComplex,
		want: []float64{
